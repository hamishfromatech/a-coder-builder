...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/hamishfromatech/versions/refs/heads/main" # Void

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/hamishfromatech/A-Coder/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/hamishfromatech/A-Coder/releases" # Void
fi
